# 
# Project automation script for pinsec 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source pinsec.tcl), then you can
...
set myProject "pinsec"
set myScript "pinsec.tcl"
...
proc add_source_files {} {
   ...
   xfile add "dvid_out/dvid_out.vhd"
   xfile add "dvid_out/dvid_out_clocking.vhd"
   xfile add "dvid_out/output_serialiser.vhd"
   xfile add "dvid_out/tmds_encoder.vhd"
   xfile add "ipcore_dir/Clock.v"
   xfile add "miniSpartan6-plus.ucf"
   xfile add "pinsec/Pinsec.v"
   xfile add "top.v"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/local/home/roman/projects/spartan/miniSpartan6-plus/projects/pinsec/work/xst" -process "Synthesize - XST"
